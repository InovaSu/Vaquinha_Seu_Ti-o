...
def carregar_dados():
    if not os.path.exists(DATA_FILE):
        dados_iniciais = {
            ...
            "descricao": "Estamos arrecadando para ajudar em uma causa importante.",
            "meta": 15000.0,
            "arrecadado": 0.0,
            "pix": "seu-pix-aqui",
            "mensagem": "Qualquer ajuda faz diferença. Obrigada por contribuir."
        }
...
<body>
    <div class="card">
        ...
        <div class="rodape">Compartilhe esta página com quem quiser ajudar.</div>
    </div>
</body>
</html>
"""
